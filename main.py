...
value_iterator = Value_iterator(enumerator, alpha=0.7, delta=0.01, epsilon=0.1, lose_cost=10000, win_cost=-1000, move_cost=10, eat_cost=-1e1, power=0, control_accuracy=True, logging=True, stay_penalty=10000)
value_iterator.run()
value_iterator.store_policy()
value_iterator.store_value_function()
pacmam_game = Game(value_iterator, pretrained=True, tile_size=50, fps=10, logging=True)
