...
policy_iterator = Neural_Policy_iterator(state_initializer, max_episodes=50000, renderer=None, logging=True, power=5, alpha = 0.001, gamma = 0.9, epsilon = 1.0, eat_reward = 1000, move_reward=-5, lose_reward=-1000, win_reward=10000)
