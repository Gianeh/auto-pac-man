...
policy_iterator = Neural_Policy_iterator(state_initializer, max_episodes=100000, renderer=None, logging=True, power=2, alpha = 0.001, gamma = 0.9, epsilon = 1.0, eat_reward = 1000, move_reward=-4, lose_reward=-1000, win_reward=10000)
